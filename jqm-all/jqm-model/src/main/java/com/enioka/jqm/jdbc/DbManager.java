...
/**
 * Handles the one and only database connection pool of the application. Handles default properties loading (may be overlaoded at
 * runtime).<br>
 * <br>
            ...
            synchronized (DbManager.class)
            {
                if (db == null)
                {
                    try
                    {
                        ...
                        // If not osgi we may need to specify the db adapter plugin list with the ones embedded in the current bundle
                        ...
                        if (!isOsgiContext() && props.getProperty("com.enioka.jqm.jdbc.adapters") == null)
                        {
                            props.setProperty("com.enioka.jqm.jdbc.adapters",
                                    "com.enioka.jqm.jdbc.DbImplPg,com.enioka.jqm.jdbc.DbImplHsql,com.enioka.jqm.jdbc.DbImplOracle,com.enioka.jqm.jdbc.DbImplMySql8,com.enioka.jqm.jdbc.DbImplMySql,com.enioka.jqm.jdbc.DbImplDb2");
                        }

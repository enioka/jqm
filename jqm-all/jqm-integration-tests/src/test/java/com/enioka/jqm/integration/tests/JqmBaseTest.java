...
public class JqmBaseTest
{
    ...
    public Option[] config()
    {
        Option[] res = new Option[] {
                ...
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-hsql").versionAsInProject(),
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-mysql").versionAsInProject(),
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-mysql8").versionAsInProject(),
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-oracle").versionAsInProject(),
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-db2").versionAsInProject(),
                mavenBundle("com.enioka.jqm", "jqm-dbadapter-pg").versionAsInProject(),
